  ...
  return (
    <div className="min-h-screen p-8">
      <main className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">FlashVote</h1>
        <p className="text-xl text-muted-foreground mb-8">
          A flexible, real-time voting and sentiment-tracking platform
        </p>
        
        <div className="p-6 bg-white shadow-lg rounded-lg mb-8">
          <h2 className="text-2xl font-semibold mb-4">Welcome to FlashVote</h2>
          <p className="text-gray-600 mb-6">
            FlashVote allows you to create dedicated pages to capture quick, aggregated user votes.
